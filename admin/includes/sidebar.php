 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <!-- <li class="nav-item">
         <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
             <i class="fas fa-newspaper fa-2x text-gray-300"></i>
             <span>Images</span>
             <i style="margin-left: 6rem; font-size: 0.8rem;" class="fas fa-chevron-next  text-gray-300"></i>
         </a>
         <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="./imageposts.php">View Images</a>
                 <a class="collapse-item" href="./imageposts.php?source=add_image">Add Image</a>
             </div>
         </div>
     </li> -->
     <li class="nav-item">
