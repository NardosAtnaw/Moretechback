...
if (isset($_POST['create_post'])) {
  ...
  $query = "INSERT INTO posts(post_titlecategory , post_category, post_content , post_subcategory ,post_subcontent  ) ";
  $query .= "VALUES( '$post_titlecategory_id' , '$post_category_id' , '$post_content', '$post_subcategory_id' ,'$post_subcontent'  ) ";
